...
P_Valores <- c(TesteJB1$p.value,TesteJB2$p.value,TesteJB3$p.value)  P_Valores <- c(TesteJB1$p.value,TesteJB2$p.value,TesteJB3$p.value)   #Cria um vetor(uma coluna de dados) com os valores p dos testes
